...
public class MainActivity3 extends Activity implements View.OnClickListener {
    ...
    private EditText teachingAssistant;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        instructor = (EditText) findViewById(R.id.instructorEdit);
        teachingAssistant = (EditText) findViewById(R.id.teachingAssistantEdit);
        ...
        if (extras != null)
        {
            ...
            Cursor classCursor =  databaseConnector.getOneClass(text);
            ...
            instructor.setText(classCursor.getString(instructorIndex));
            teachingAssistant.setText(classCursor.getString(teachingAssistantIndex));
    ...
    private void SaveClasses(){
        ...
        if (getIntent().getExtras() == null)
        {
            ...
            databaseConnector.insertClassDetails(
                    ...
                    teachingAssistant.getText().toString(),
...
//changed insertClassSchedule to upsertClassSchedule. Change the code in Database Connector --Priyanka
    ...
    public void makeClassTag(String classDay, String startTime, String endTime){
